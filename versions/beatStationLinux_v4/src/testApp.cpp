...
#define NAME_STRING "CHOOSE A USERNAME"
//--------------------------------------------------------------
void testApp::setup(){
    ...
    */
    ...
    instrGUI1 = "Please choose a username and click START.";
    ...
    gui1->addWidgetDown(new ofxUILabel(NAME_STRING, OFX_UI_FONT_MEDIUM));
